...
class User(models.Model):
    ...
    lat 		= models.FloatField("Address latitude", blank=True, default=0)
    lon			= models.FloatField("Address longtitude", blank=True, default=0)
...
class Book(models.Model):
    ...
    lend 		= models.ForeignKey(User, null=True, related_name=" books on lend")
    borrow 		= models.ForeignKey(User, null=True, related_name="books borrowed")
    # interest    = models.ForeignKey(to=Interest)
